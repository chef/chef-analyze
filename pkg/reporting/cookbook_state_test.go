...
func TestCookbookStateRecordCorrectableAndOffenses(t *testing.T) {
	csr := subject.CookbookStateRecord{
...
func TestCookbookStateEmpty(t *testing.T) {
	c, err := subject.NewCookbookState(
...
func TestCookbookState_downloadErrors(t *testing.T) {
}

// Given a failure in fetching node usage for a cookbook,
// the result set is as expected
func TestCookbookState_usageStatErrors(t *testing.T) {
}
